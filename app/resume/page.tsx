...
const Index = () => {
  ...
  const handleGenerate = (data?: any) => {
    if (data && data.status === "success") {
      ...
      // Fallback if triggered without data (e.g. initial render loading state or error)
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex flex-col items-center gap-8 px-6 md:px-10 py-8 max-w-3xl mx-auto w-full">
        ...
        <div className="w-full space-y-6">
          {!showResults && !isGenerating && (
            <div className="neu-card flex flex-col items-center justify-center h-80 gap-4 animate-pulse-gentle">
          ...
          {isGenerating && (
            <div className="neu-card flex flex-col items-center justify-center h-80 gap-4">
          ...
          {showResults && resumeData && (
            <>
              ...
              <div>
                <h2 className="text-lg font-semibold text-foreground mb-3">ATS Analysis</h2>
